  ...
  <section class="Home pt-4 sm:pt-6">
    <Alert class="pt-0 pb-2 sm:py-4">
      ...
      <AlertDescription class="p-0 text-xs sm:text-sm">
        ...
        <p>神眠`图床 是 <a class="text-slate-400" href="https://zycs-img-bn1.pages.dev/" target="_blank" title="Demius`blog">Demius`blog</a> 支持并维护的文件上传项目，不致力于为用户提供稳定的永久存储服务，上传的一切项目文件后果自负。</p>
        <p style="font-weight: bold">开源地址: <a class="text-[#0969da]" href="https://blog.demius.tech/" target="_blank">Demius`blog</a></p>
      </AlertDescription>
    </Alert>
